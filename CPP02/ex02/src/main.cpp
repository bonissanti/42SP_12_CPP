...
int	main(void)
{
...

	{
		...
		std::cout << "Return: " << min1 << std::endl;
		std::cout << "After pre-increment: " << ++min1 << std::endl;

		Fixed const min2 = Fixed::min(a, b);
		std::cout << "Return: " << min2 << std::endl;
	}
	...
	{
		std::cout << "\nTest #4 - divide by 0" << std::endl;

		Fixed a(Fixed(10) / Fixed(0));
